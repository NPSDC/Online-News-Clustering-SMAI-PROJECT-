...
def main():
    filename = "fp_week1.pickle"
    getBurstyWeights(filename)
    bvocab, weights = pickle.load(open("burstiness.pickle", "rb"))
    corpus, topics, titles, time = pickle.load(open(filename, "rb"))
...
# main()
getBurstyWeights("fp_week1.pickle")
